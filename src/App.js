...
export default function App() {
	...
	return ( 
		<>
			...
			<div className="background-mon"></div>
			<PokemonList pokemon={pokemon} pokedexStyle={pokedexStyle} listRef={ref} initSwiper={initSwiper} updateSwiper={updateSwiper} swiper={swiper} /> 
