    ...
    <div className="list">
		{individualPokemonData.map(data => { 
			return <div key={data.id} className="pokemon">
				<img src={imgStyle === "default" ? imgStyle === "alt" ? data.sprites.front_default : data.sprites.other.dream_world.front_default : data.sprites.front_default} alt={data.name + " sprite"} height="100" width="100"/>
